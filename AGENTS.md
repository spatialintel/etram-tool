...
- Mount a volume at `/app/data` so `data/jobs/` and uploaded data survive restarts. ≥ 2 GB RAM for full-month May packs (smaller tiers OOM/restart).
