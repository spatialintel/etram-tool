...
export const DEFINITIONS = {
  ridership: {
    ...
    note: 'One ETM ticket row = one passenger',
  },
  ...
  lf: {
    ...
    note: 'Capacity-km uses seated capacity, not crush load',
    target: 0.6,
  },
  ...
  epkm: {
    ...
    note: 'Cost recovery indicator: revenue earned for every kilometre operated',
  },
  epb: {
